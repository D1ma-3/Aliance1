        ...
        <div class="trademark-cards">
         <div class="trademark-card">
          <svg class="trademark-card-logo">
            <use href="img/sprite.svg#ART"></use>
          </svg>
        ...
        <div class="cta-from-wrapper container">
          <form action="#" class="cta-from">
            ...
            <div class="input-group">
              <input id="user-n" type="text" class="input" placeholder=" ">
              <label class="input-group-label" for="user-n">Имя</label>
            </div>
            <!-- /.input-group -->
            <div class="input-group">
              <input id="user-p" type="tel" class="input" placeholder=" ">
